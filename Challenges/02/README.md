...
2. Начертавате произволна отсечка нагоре: ![0](https://raw.github.com/nelly-hateva/python-homeworks/master/Challenges/02/0.png)
3. Приемате точката, до която сте стигнали за точка на въртене и завъртате целия обект на 90 градуса по часовниковата стрелка: ![1](https://raw.github.com/nelly-hateva/python-homeworks/master/Challenges/02/1.png)
4. Повтаряте стъпка 3 докато ви писне: ![2](https://raw.github.com/nelly-hateva/python-homeworks/master/Challenges/02/2.png)


Ето и следващата итерация: ![3](https://raw.github.com/nelly-hateva/python-homeworks/master/Challenges/02/3.png)
